...
class Level extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image("foligno", "game/assets/mappafol.png");
        this.load.image("interno", "game/assets/tailortailes.png");
        this.load.tilemapTiledJSON("level-1", "game/assets/MappaFol.json");
    ...
    create() {
        ...
        var foligno = map.addTilesetImage("mappafol", "foligno");
        var interno = map.addTilesetImage("tailortailes", "interno");
        map.createDynamicLayer("Livello1", [foligno, interno]);

        // Set physics boundaries from map width and height.
        //this.physics.world.setBounds(0, 0, this.map.widthInPixels, this.map.heightInPixels);

        // Collisions based on layer.
        this.Livello1.setCollisionByProperty({collides: true});

        // Set the above player layer higher than everything else.
        this.Livello1.setDepth(10);
        ...
        // Add collisions.
        this.physics.add.collider(this.player,  this.Livello1);
